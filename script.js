...
// Cabello
const c1  = createLayer('assets/img/02_cabello/01_Corona_Superior.png', CAPAS.c1, 'C1 Corona', 0xd4a574);
const c2  = createLayer('assets/img/02_cabello/02_Frontal_Superior.png', CAPAS.c2, 'C2 Frontal', 0xc9955a);
const c3  = createLayer('assets/img/02_cabello/03_Lateral_Superior_Derecho.png', CAPAS.c3, 'C3 Lat Der', 0xbf8a4a);
const c4  = createLayer('assets/img/02_cabello/04_Central_Derecho.png', CAPAS.c4, 'C4 Central Der', 0xbf8a4a);
const c5  = createLayer('assets/img/02_cabello/05_Lateral_Inf_Derecho.png', CAPAS.c5, 'C5 Lat Inf Der', 0xb57d3a);
const c6  = createLayer('assets/img/02_cabello/06_Puntas_Derechas.png', CAPAS.c6, 'C6 Puntas Der', 0xab702a);
const c7  = createLayer('assets/img/02_cabello/07_Inferior_Central.png', CAPAS.c7, 'C7 Inf Central', 0xab702a);
const c8  = createLayer('assets/img/02_cabello/08_Masa_Inf_Principal.png', CAPAS.c8, 'C8 Masa Inf', 0xa1631a);
const c9  = createLayer('assets/img/02_cabello/09_Central_Izquierdo.png', CAPAS.c9, 'C9 Central Izq', 0x97560a);
const c10 = createLayer('assets/img/02_cabello/10_Inferior_Izquierdo.png', CAPAS.c10, 'C10 Inf Izq', 0x97560a);
const c11 = createLayer('assets/img/02_cabello/11_Cuello_Hombro.png', CAPAS.c11, 'C11 Cuello', 0x8d4900);

// Rostro (RUTAS ACTUALIZADAS)
const rostroBase = createLayer('assets/img/01_rostro/01_Rostro_Base_Completa.png', CAPAS.rostroBase, 'Rostro Base', 0xf5d0b8);
const nariz      = createLayer('assets/img/01_rostro/02_Nariz.png', CAPAS.nariz, 'Nariz', 0xe8c0a8);
const labios     = createLayer('assets/img/01_rostro/03_Labios.png', CAPAS.labios, 'Labios', 0xd4848a);

// Ojos (RUTAS ACTUALIZADAS)
const ojoIzq = createLayer('assets/img/01_rostro/04_Ojo_Izquierdo.png', CAPAS.ojoIzq, 'Ojo Izq', 0x4488ff);
const ojoDer = createLayer('assets/img/01_rostro/05_Ojo_Derecho.png', CAPAS.ojoDer, 'Ojo Der', 0x8b4513);

// Párpados (RUTAS ACTUALIZADAS)
const parpIzq = createLayer('assets/img/01_rostro/06_Parpado_Izquierdo.png', CAPAS.parpIzq, 'Párpado Izq', 0xf5d0b8);
const parpDer = createLayer('assets/img/01_rostro/07_Parpado_Derecho.png', CAPAS.parpDer, 'Párpado Der', 0xf5d0b8);

// Pestañas y Cejas (RUTAS ACTUALIZADAS)
const pestanas = createLayer('assets/img/01_rostro/08_Pestanas.png', CAPAS.pestanas, 'Pestañas', 0x2d1b0e);
const cejas    = createLayer('assets/img/01_rostro/09_Cejas.png', CAPAS.cejas, 'Cejas', 0x4a2a1a);

// Glow (RUTA ACTUALIZADA)
const glow = createLayer('assets/img/01_rostro/10_Control_Glow.png', CAPAS.glow, 'Glow', 0xaa66ff);
